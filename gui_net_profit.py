...
class window:
    ...
    def __init__(self, master):
        ...
        self.label.pack()
        self.revenue_button = customtkinter.CTkButton(self.master, text="Чистая прибыль",
    ...
    def new_window(self):
        ...
        self.window1.title("Чистая прибыль")
    ...
    def window_trend_and_sesonal(self):
        plt.plot(df['net_profit'], df['net_profit'])
        plt.title('Чистая прибыль')
        plt.xlabel('Недели')
    ...
    def stationarity(self):
        ...
        adf_result = adfuller(df['net_profit'])
    ...
    def prediction(self):
        ...
        if len(days_entry_value.strip()) == 0:
            ...
            if days == 0:
                ...
                model_sarima = sm.tsa.SARIMAX(df, order=(1,0,1), seasonal_order=(1,1,0, 108))
    ...
    def prediction_graphics(self):
        ...
        plt.plot(pred)
        plt.title('График чистой прибыли')
        plt.xlabel('Недели')
        plt.ylabel('Чистая прибыль')
        plt.show()
