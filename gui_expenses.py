...
df = pd.read_csv(r'C:\Users\nglls\OneDrive\Рабочий стол\expenses.csv')
...
class window:
    ...
    def __init__(self, master):
        ...
        self.label.pack()
        self.revenue_button = customtkinter.CTkButton(self.master, text="Расходы",
    ...
    def stationarity(self):
        ...
        adf_result = adfuller(df['expenses'])
    ...
    def prediction(self):
        ...
        if len(days_entry_value.strip()) == 0:
            ...
            if days == 0:
                ...
                model = SARIMAX(df, order=(1, 0, 1), seasonal_order=(1, 1, 0, 108)) 
                model_fit = model.fit() 
                global pred
